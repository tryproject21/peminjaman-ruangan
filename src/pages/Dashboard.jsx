...
import { getBookings, editBooking, checkOverlap, ROOMS, KELOMPOK_KERJA } from '../utils/storage';
import { ChevronLeft, ChevronRight, Users, X, Clock, MapPin, FileText, Download, Pencil, Save, AlertCircle } from 'lucide-react';
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem', flexWrap: 'wrap', gap: '0.75rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <button onClick={() => {
            ...
            padding: '0.4rem 1.1rem', fontSize: '0.8125rem', fontWeight: '500',
                        ...
                        >
                          ...
                          {!isShort && (
                            <>
                              ...
                              <div style={{ fontSize: '0.625rem', opacity: 0.85, display: 'flex', alignItems: 'center', gap: '3px', marginTop: '2px' }}>
                                <Users size={10} /> {b.kelompokKerja}
                              </div>
                            </>
                          )}
                          {isShort && (
                            <div style={{ fontSize: '0.625rem', opacity: 0.85, whiteSpace: 'nowrap' }}>
                              {b.startTime} – {b.endTime} · {b.kelompokKerja}
                            </div>
                          )}
                        </div>
                      );
                ...
                <div style={{ background: colors.bg, color: '#fff', padding: '1.25rem 1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontSize: '0.8125rem', opacity: 0.9 }}>
                      Diajukan oleh {selectedBooking.kelompokKerja}
                    </p>
                  </div>
              ...
              {!isEditing && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.9rem' }}>
                    ...
                    <span style={{ fontWeight: '500' }}>Kelompok Kerja {selectedBooking.kelompokKerja}</span>
                  </div>
                  ...
                  {isSecretary && (
                    <div style={{ borderTop: '1px solid var(--border-light)', paddingTop: '1rem', display: 'flex', justifyContent: 'flex-end' }}>
                      <button className="btn btn-outline" onClick={startEdit} style={{ fontSize: '0.8125rem' }}>
                        <Pencil size={14} /> Edit Peminjaman
                      </button>
                    </div>
                  )}
                </div>
